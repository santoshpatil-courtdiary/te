...
function isLiveApi(url) {
  return /googleapis\.com|firestore|identitytoolkit|securetoken|accounts\.google\.com|graph\.microsoft\.com|login\.microsoftonline\.com/.test(url.host);
}
